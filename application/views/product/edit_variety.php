						...
						<div class="forms">
							<div class="form-three widget-shadow">
								<div class=" panel-body-inputin">
									<form class="form-horizontal" action="<?= base_url(); ?>update_variety" method="post" enctype="multipart/form-data">
										<input type="hidden" name="url" id="url" value="<?= base_url(); ?>">
										<input type="hidden" name="id" id="id" value="<?= $variety[0]['id']; ?>">
										
										<div class="form-group">
											<label class="col-md-2 control-label">Product Variety</label>
											<div class="col-md-8">
												<div class="input-group">
													<span class="input-group-addon">
														<i class="fa fa-list-ul"></i>
													</span>
													<input type="text" class="form-control1" placeholder="Product Variety" name="product_variety" id="product_variety" value="<?= $variety[0]['variety_name'] ?>">
												</div>
											</div>
											...
											<div class="col-md-8">
												<select class="form-control1 select2" name="product" id="product"> 
													...
													<?php if(!empty($allproducts)){
														...
														?>
														<option value="<?= $product['id']; ?>" <?php if($product['id'] == $variety[0]['product_id']){ echo 'selected';} ?>><?= $product['name']; ?></option>
													<?php }} ?>
												</select>
											</div>
										...
										<div class="form-group">
											...
											<div class="col-md-8">
												<div class="input-group">
													...
													<input type="hidden" name="vimage" id="vimage" value="<?= $variety[0]['variety_image'] ?>">
												</div>
											</div>
											<span class="text-danger "><?= $vimage_err; ?></span>
											<div class="col-md-2">
												<?php if($variety[0]['variety_image']) {?>
													<img src="<?= base_url('public/uploads/cat_image/'.$variety[0]['variety_image']);?>" width="50" height="50">
												<?php }?>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-8">
													<textarea name="editor1" id="editor1"><?php if($variety[0]['variety_details']){ echo $variety[0]['variety_details']; } ?></textarea>
											</div>
										...
										<div class="form-group">
											...
											<div class="col-md-8">
													<textarea name="editor2" id="editor2"><?php if($variety[0]['variety_details_hi']){ echo $variety[0]['variety_details_hi']; } ?></textarea>
											</div>
